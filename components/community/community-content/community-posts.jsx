...
import ShortsVPostCard from "@/components/shortsv/shortsv-post-card";
import ReelsHomeCard from "@/components/reels/reels-home-card";
import { useScrollTracker } from "@/hooks/use-scroll-tracker";

export default function CommunityPosts({ initialPosts, session, communityId }) {
  ...
  const { data, fetchNextPage, isFetchingNextPage } = useInfiniteQuery({
    queryKey: ["infinite-query-community-post", communityId],
    queryFn: fetchPosts,
    initialPageParam: 1,
