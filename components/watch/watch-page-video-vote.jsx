...
const WatchPageVideoVote = ({ postId, initialVote, initialVotesAmt }) => {
  ...
  return (
    <div className="flex items-center justify-center my-1">
      ...
      <button onClick={() => vote("UP")} aria-label="upvote">
        <ArrowBigUp
          className={cn(
            "h-9 w-9 stroke-[1.6px]  hover:text-orange-600 hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-full p-[5px]",
            {
      ...
      {/* currentvote */}
      <p className="text-center font-semibold  text-neutral-600 px-1 dark:text-neutral-200 text-sm ">
        {votesAmt}
      </p>
      ...
      <button onClick={() => vote("DOWN")} aria-label="downvote">
        <ArrowBigDown
          className={cn(
            "h-9 w-9 stroke-[1.6px] p-[5px]  hover:text-violet-800 dark:hover:text-violet-500 hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-full",
            {
...
export default WatchPageVideoVote;
