...
const AllActivitySideBar = () => {
  ...
  return (
    <div className="w-[30vw] border-r p-3 min-h-svh">
      <div>
        {pathname === "/allactivity/trash" && (
          <h1 className="text-2xl font-bold pl-2">Trash</h1>
        )}
      ...
      <div className="">
        ...
        <div>
          <Button
            ...
            variant="ghost"
            className="flex items-center justify-between gap-x-3 py-6 pr-4 pl-2 hover:bg-neutral-100 rounded-md  cursor-pointer w-full"
          >
            ...
            {toggleArchive ? (
              <ChevronUp className="h-5 w-5 stroke-[3px] text-neutral-800" />
            ) : (
              <ChevronDown className="h-5 w-5 stroke-[3px] text-neutral-800" />
            )}
          </Button>
          {/* sub buttons */}
          {toggleArchive && (
            <div className="ml-8">
              <Button
                variant="ghost"
                className="flex items-center justify-start gap-x-3 mt-2 hover:bg-neutral-100 rounded-md cursor-pointer w-full py-6"
              >
                <div className="bg-neutral-200 p-2 rounded-full">
                  <Archive className="h-5 w-5" />
                </div>
                <div className="relative flex flex-col gap-0.2">
                  <p className="font-semibold m-0">Post archive</p>
                </div>
              </Button>
              <Button
                variant="ghost"
              ...
              >
                ...
                <div className="relative flex flex-col gap-0.2">
                  <p className="font-semibold m-0">Story archive</p>
                </div>
              </Button>
            </div>
          )}
        ...
        {pathname !== "/allactivity/trash" && (
          <Link
            ...
            className="flex items-center gap-x-3 mt-2 pl-2 hover:bg-neutral-100 p-1 rounded-md cursor-pointer"
          >
            <div className="bg-neutral-200 p-2 rounded-full">
